...
export default function Oreh() {
  const data = useStaticQuery(graphql`
    query {
      img1: file(relativePath: { eq: "products/oreh_03.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
      ...
      img2: file(relativePath: { eq: "products/oreh_04.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid_tracedSVG
          }
      ...
      img3: file(relativePath: { eq: "products/oreh_05.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid_tracedSVG
          }
