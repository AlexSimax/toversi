...
export default function Ebenovoe() {
  const data = useStaticQuery(graphql`
    query {
      img1: file(relativePath: { eq: "products/eben_03.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
      ...
      img2: file(relativePath: { eq: "products/eben_04.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid_tracedSVG
          }
      ...
      img3: file(relativePath: { eq: "products/eben_05.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid_tracedSVG
          }
